...
const TiendaItem = ({ data, section }) => {
  return (
    <article className="aspect-square object-cover overflow-hidden relative">
      <Link to={`/${section}/${data.id}`} className="absolute z-20 w-full h-full top-0 p-6 bg-black bg-opacity-60 opacity-100 lg:opacity-0 hover:opacity-100 flex flex-col justify-end">
